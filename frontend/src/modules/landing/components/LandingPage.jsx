...
const T = {
  ...
  light: {
    ...
    btnWhatsapp:  'border border-emerald-600/50 bg-emerald-500/10 text-emerald-700 hover:bg-emerald-500/20',
    footerBg:     'bg-[#e6ddd1]',
...
const DashboardMockup = ({ t }) => (
  <div className={cx('relative rounded-sm border p-5 font-mono text-xs shadow-2xl transition-colors duration-300', t.card)}>
    ...
    <div className={cx('mb-3 flex items-center gap-2 border-b pb-3', t.divider)}>
      ...
      <span className={cx('text-[0.55rem] uppercase tracking-widest', t.monoMuted)}>taller metalúrgico · sistema activo</span>
    </div>
    <div>
    ...
    <div className={cx('mt-3 flex items-center justify-between border-t pt-3', t.divider)}>
      ...
      <span className={cx('rounded-sm px-2 py-0.5 text-[0.55rem] font-black uppercase tracking-wider', t.accentTint, t.accent)}>07:32:14 ▶</span>
    </div>
  </div>
)
...
const HeroSection = ({ t, isDark }) => (
  <section className="relative flex min-h-screen flex-col justify-center overflow-hidden px-6 pb-24 pt-28 lg:flex-row lg:items-center lg:gap-20">
    <div className="pointer-events-none absolute inset-0" style={{ backgroundImage: `linear-gradient(${t.gridColor} 1px, transparent 1px), linear-gradient(90deg, ${t.gridColor} 1px, transparent 1px)`, backgroundSize: '48px 48px' }} />
    ...
    <div className="relative z-10 flex-1 space-y-7 lg:max-w-2xl">
      ...
      <div className="space-y-3">
        <h1 className="text-[3.8rem] font-black uppercase leading-[0.9] tracking-tighter sm:text-[5rem] lg:text-[5.8rem]">
          ...
          gestionando
          <br />
          <span className={t.accent}>con papel</span>
          <br />
          y Excel?
        </h1>
      ...
      <div className="flex flex-wrap gap-3">
        <Link to="/registro" className={cx('flex items-center gap-2 rounded-sm px-7 py-3.5 text-sm font-black uppercase tracking-wider shadow-lg transition', t.btnPrimary)}>
    ...
    <div className="mx-auto max-w-6xl">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        {PAIN_POINTS.map(({ icon, text }) => (
          <div key={text} className={cx('flex items-start gap-3 rounded-sm border p-4', t.painBorder)}>
    ...
    <div className="mx-auto max-w-6xl">
      <div className={cx('grid grid-cols-2 divide-y lg:grid-cols-4 lg:divide-y-0 lg:divide-x', isDark ? 'divide-slate-800' : 'divide-stone-200')}>
        {TRUST_METRICS.map(({ v, l, icon }) => (
          <div key={l} className="flex flex-col items-center gap-2 p-6 text-center">
    ...
    <div className="mx-auto max-w-6xl">
      <div className={cx('mb-12 flex flex-col justify-between gap-4 border-b pb-8 sm:flex-row sm:items-end', t.divider)}>
        <div>
          ...
          <h2 className="text-3xl font-black uppercase tracking-tight sm:text-4xl">Todo lo que necesita<br />tu taller</h2>
        </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3">
        {FEATURES.map(({ n, icon, title, desc }) => (
          <article key={n} className={cx('group relative border-b border-r p-7 transition-colors duration-200 last:border-r-0', t.card, t.cardHover)}>
      ...
      <div className="relative">
        ...
        <div className="grid gap-10 lg:grid-cols-4 lg:gap-6">
          {TIMELINE_STEPS.map(({ when, icon, title, desc }, i) => (
            <div key={when} className="relative flex gap-5 lg:flex-col lg:gap-4">
              {/* Dot */}
    ...
    <div className="mx-auto max-w-6xl">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {TESTIMONIALS.map(({ quote, name, role, initials }) => (
          <blockquote key={name} className={cx('relative rounded-sm border p-8 transition-colors duration-200', t.testimonial)}>
      ...
      {/* ROI metric */}
      <div className={cx('mt-8 rounded-sm border p-6 text-center', t.card)}>
    ...
    <div className="mx-auto max-w-6xl">
      <div className={cx('mb-12 flex flex-col justify-between gap-4 border-b pb-8 sm:flex-row sm:items-end', t.divider)}>
        <div>
          ...
          <h2 className="text-3xl font-black uppercase tracking-tight sm:text-4xl">Sin sorpresas.<br />Sin letra pequeña.</h2>
        </div>
      ...
      <div className="grid md:grid-cols-3">
        {PLANS.map(({ name, users, price, features, popular }, i) => (
          <div key={name} className={cx('relative flex flex-col border p-8 transition-colors', popular ? t.planPopular : t.planNormal, i > 0 && '-ml-px')}>
  ...
  <section className={cx('border-y px-6 py-28 text-center transition-colors duration-300', t.divider)}>
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
        <Link to="/registro" className={cx('flex items-center gap-2 rounded-sm px-10 py-4 text-sm font-black uppercase tracking-wider shadow-lg transition', t.btnPrimary)}>
