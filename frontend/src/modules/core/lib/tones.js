export const toneClasses = {
  warning: {
    ...
    metricTopBorder: 'border-t-2 border-t-amber-500/60',
  ...
  info: {
    ...
    metricTopBorder: 'border-t-2 border-t-sky-500/60',
    stockBar: 'bg-sky-400',
  },
  success: {
    ...
    metricTopBorder: 'border-t-2 border-t-emerald-500/60',
  ...
  secondary: {
    ...
    metricTopBorder: 'border-t-2 border-t-violet-500/60',
  ...
  danger: {
    ...
    metricTopBorder: 'border-t-2 border-t-rose-500/60',
  ...
  neutral: {
    ...
    metricTopBorder: 'border-t-2 border-t-slate-500/60',
