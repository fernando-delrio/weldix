        ...
        "metrics": [
            {
                "key": "pending",
                "label": "Pendientes",
                "value": sum(1 for j in jobs if j.estado == "pendiente"),
                "tone": "warning",
            },
            {
                "key": "in_progress",
                "label": "En proceso",
                "value": sum(1 for j in jobs if j.estado == "en_proceso"),
                "tone": "info",
            },
            {
                "key": "week",
                "label": "Esta semana",
                "value": sum(1 for j in jobs if j.estado in ("listo", "entregado")),
                "tone": "success",
            },
        ],
